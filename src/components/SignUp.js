      ...
      {formik => (
        <div className={classes.container}>
          <Form className={classes.form}>
            ...
            <TextField label="Matching Password" name="matchingPassword" type="password" />
            <button className={classes["submit-btn"]} type="submit">Sign Up</button>
            <Link className={classes.redirect} to="/signin">You already have an account? Sign in</Link>
          </Form>
        </div>
      )}
    </Formik>
